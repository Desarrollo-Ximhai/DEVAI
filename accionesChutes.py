        ...
        while True:
            ...
            if tool_calls:
                ...
                for tool_call in tool_calls:
                    ...
                    try:
                        func_args = json.loads(funcMeta.get("arguments", "{}"))
                    except Exception:
                        func_args = {}
...
async def generate_response_chutes(prompt: str, model_name: str, api_key: str, archivos: list = None, configuracion: dict = None, tools_schemas: list = None, tool_functions: dict = None, system_instruction: str = None, history: list = None):
    """
